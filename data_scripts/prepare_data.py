...
# ---------------------------
# CREATE CSV FILES FOR ROBERTA
# ---------------------------
print("\nCreating CSV files for RoBERTa...")
...
train_df.to_csv("train_texts.csv", index=False)
...
test_df.to_csv("test_texts.csv", index=False)

print("Created train_texts.csv")
print("Created test_texts.csv")
